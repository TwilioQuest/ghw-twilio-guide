...
- [Daily challenges](#daily-challenges)
  ...
  - [Day 1: Get ready to hack with Twilio.](#day-1-get-ready-to-hack-with-twilio)
    ...
    - [Step 2: Upgrading your account](#step-2-upgrading-your-account)
    - [Step 3: Buy Two Twilio numbers](#step-3-buy-two-twilio-numbers)
    - [Step 4: Installing the Twilio CLI](#step-4-installing-the-twilio-cli)
    - [Step 5: Installing the Dev Phone](#step-5-installing-the-dev-phone)
    - [Step 6: Installing `curl`](#step-6-installing-curl)
    - [Step 7: Daily challenge complete! Time to submit.](#step-7-daily-challenge-complete-time-to-submit)
  - [Day 2: Receive your first phone call using TwiML bins and Dev Phone.](#day-2-receive-your-first-phone-call-using-twiml-bins-and-dev-phone)
    - [Step 1: Create a TwiML bin to handle a phone call](#step-1-create-a-twiml-bin-to-handle-a-phone-call)
    - [Step 2: Link your TwiML bin to your Twilio number](#step-2-link-your-twiml-bin-to-your-twilio-number)
    - [Step 3: Test it using Dev Phone](#step-3-test-it-using-dev-phone)
    - [Step 4: Daily challenge complete! Time to submit.](#step-4-daily-challenge-complete-time-to-submit)
  - [Day 3: Make your first outbound phone call using `curl`.](#day-3-make-your-first-outbound-phone-call-using-curl)
    - [Step 1: Check out the Twilio documentation on making calls](#step-1-check-out-the-twilio-documentation-on-making-calls)
    - [Step 2: Understanding the `curl` command](#step-2-understanding-the-curl-command)
    - [Step 3: Building our `curl` request](#step-3-building-our-curl-request)
    - [Step 4: Make the request](#step-4-make-the-request)
    - [Step 5: Daily challenge complete! Time to submit.](#step-5-daily-challenge-complete-time-to-submit)
  - [Day 4: Setting up a web application with ngrok and webhooks.](#day-4-setting-up-a-web-application-with-ngrok-and-webhooks)
    - [Step 1: Create a Node.js or Python web application](#step-1-create-a-nodejs-or-python-web-application)
    - [Step 2: Install ngrok](#step-2-install-ngrok)
    - [Step 3: Set your Twilio webhook](#step-3-set-your-twilio-webhook)
    - [Step 4: Daily challenge complete! Time to submit.](#step-4-daily-challenge-complete-time-to-submit-1)
  - [Day 5: Receiving SMS messages with our web application.](#day-5-receiving-sms-messages-with-our-web-application)
    - [Step 1: Add a new endpoint](#step-1-add-a-new-endpoint)
    - [Step 2: Getting the message contents](#step-2-getting-the-message-contents)
    - [Step 3: Send an SMS from the Dev Phone](#step-3-send-an-sms-from-the-dev-phone)
